	...
	<div id="wrap">
			...
			table 
		{
			...
			tr:nth-child(even) 
			{
				...
				<form>
				<h1><font style="background-color:#00CCFF">PATIENT DETAILS</font></h1>
...
$d=DATE("Y-m-d");
$sql = "SELECT * from tbl_appointment where date='$d'";
...
$messag=$row['message'];
echo "<center>";
echo "<tr><td>$pid</td><td>$nam</td><td>$em</td><td>$dat</td><td>$tim</td><td>$messag</td></tr>";
echo "</center>";
}
