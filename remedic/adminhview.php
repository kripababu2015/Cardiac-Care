    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item"><a href="admindataset.php" class="nav-link">Detaset  Management</a></li>
          <li class="nav-item"><a href="admingraph.php" class="nav-link">view Graph Analysis</a></li>
...
$query = "select * from tbl_login where type='hospital' and
...
else
{
 ...
 while ($row = mysql_fetch_row($result))
 {
  ...
  echo '<td><a href=approvehospital1.php?id='.

$idval.'>Approve</a></td><td><a href=deletehospital.php?id='.
