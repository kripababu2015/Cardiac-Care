...
<div class="art-object0" data-left="100%">
    ...
    <a href="adminpage.php"><h3>Back to Home page</h3></a><br> 
    <section class="ftco-section bg-light">
      <div class="container">
        <div class="row justify-content-center mb-5 pb-3">
          
		  <br><table><tr><td>
		  <h4>Click the above links to view the medical summary</h4></td></tr>
			<tr><td><h5><a href="chart1.php">view graphical representation using bar chart</a></h5></td></tr>
			<tr><td><h5><a href="chart2.php">view graphical representation using pie chart</a></h5></td></tr>
		  	<tr><td><h5><a href="chart3.php">view graphical representation using bar chart</a></h5></td></tr>
         </div>
      </div>
    </section>
