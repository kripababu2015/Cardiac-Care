...
<tr><td></td>
<td><h1>click to predict the result</h1><br><input type="submit" name="btnsubmit" value="predict"></td></tr></table></form>
...
echo "<tr><th>Patient ID</th><th>Predicted Result</th></tr>";
while($row=mysql_fetch_array($data))
{
$pid1=$row['pid'];
$ag=$row['prediction'];

echo "<tr><td>$pid1</td><td>$ag</td></tr>";
