...
$query = "select * from tbl_login where type='doctor' and
...
else
{
 ...
 while ($row = mysql_fetch_row($result))
 {
  ...
  echo '<td><a href=approvedoctor1.php?id='.

$idval.'>Approve</a></td><td><a href=deletedoctor.php?id='.
...
?>
		...
		<a href="adminapp.php"><h3><font color="#0066FF">Back to Approval page</font></h3></a>
      </div>
    </section>
