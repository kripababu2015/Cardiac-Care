...
{
$sql="insert into tbl_usereg values('$_POST[id1]','$_POST[fname]','$_POST[lname]','$_POST[password]','$_POST[email]','$_POST[phone]')";
//echo $sql;
...
$sql="select max(user_id) as mid from tbl_usereg";
...
first name  <input name=fname required=required maxlength=18><br>
last name  <input name=lname required=required maxlength=18><br>
