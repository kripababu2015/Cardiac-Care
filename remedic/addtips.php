    ...
    <section class="ftco-section bg-light">
	  <div class="container">
        <div class="row justify-content-center mb-5 pb-3">
			...
			<td></td>
			<td><input type="submit" name="btnsubmit" value="ADD TIPS" style="background:#0066CC; border:thick; padding: 8px 20px; color:#FFFFFF" font-family:Algerian; font-size=30px; height:80%;"/></td></td>
			</tr>
			</table>
...
$sql="insert into tbl_tip values('$_POST[dname]','$_POST[disease]','$_POST[treatment]','$_POST[medication]')";
mysql_query($sql,$con);
