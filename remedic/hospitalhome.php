    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item active"><a href="hospdept.php" class="nav-link">Department Management</a></li>
          <li class="nav-item"><a href="hospgraph.php" class="nav-link">Graph Analysis</a></li>
          <li class="nav-item"><a href="hospemr.php" class="nav-link">EMR creation</a></li>
          <li class="nav-item"><a href="hosppro.php" class="nav-link">PRO</a></li>
