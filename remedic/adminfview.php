...
<div class="art-object0" data-left="100%">
    ...
    <div class="hero-wrap" style="background-image: url('images/bg_1.jpg'); background-attachment:fixed;">
 	 ...
 	 <br> <a href="adminpage.php"><h3><font color="blue">Back to home page</font></h3></a>
...
echo "<table border=2  width=50% bgcolor=pink>"; 
echo "<tr><th>Patient ID</th><th>Date</th><th>Time</th><th>Feedback</th></tr>";
...
echo "<tr><td>$pid1</td><td>$ag</td><td>$ang</td><td>$suga</td></tr>";
