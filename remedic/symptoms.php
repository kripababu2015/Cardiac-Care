...
<html lang="en">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
      <a class="navbar-brand" href="indexcopy.php"><i class="flaticon-pharmacy"></i><span>CaRdIaC</span>CaRe</a>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center" data-scrollax-parent="true">
          <div class="col-md-8 ftco-animate text-center">
            <p class="breadcrumbs"><span class="mr-2"><a href="indexcopy.php">Home</a></span> <span>Heart Information</span></p>
            <h1 class="mb-3 bread">Heartinformation</h1>
...
<div>
<h1 class="style1">SYMPTOMS OF VARIOUS HEART DEFECTS</h1>  
    <p  class="a style1">
...
<br>
	Abnormal awareness of heartbeat  </p>  
<a href="heartinformation.php"><h2>Back</h2></a>  
</div>
