...
<body>
<form action="appdemo.php" mehod="POST">
<table>
<tr>
<td>Name</td>
...
<td><input type="submit" value="OK" name="btnsubmit"></td>
</tr>
</table></form>
 <?php
...
{ 
$sql="insert into tbl_appoinment values('$_POST[name]','$_POST[email]','$_POST[date]','$_POST[time]','$_POST[message]')";
mysql_query($sql,$con);
echo $sql;
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="appointment_date" name="date">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="appointment_time" class="text-black">Time</label>
                    <input type="text" class="form-control" id="appointment_time" name="time">
                  </div>
                </div>
              </div>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item"><a href="doctoranalysis.php" class="nav-link">Analysis</a></li>
