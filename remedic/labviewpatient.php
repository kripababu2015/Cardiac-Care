...
$sql="SELECT u.p_id, e.name, e.email,u.dname FROM `tbl_appointment` AS e INNER JOIN `tbl_dtest` AS u ON e.p_id = u.p_id";
$data=mysql_query($sql,$con);
echo "<table border=1 align=center width=50%>";
echo "<tr><th>Patient ID</th><th>Name</th><th>email id</th><th>doctor</th></tr>";
...
echo "<tr><td>$pid</td><td>$nam</td><td>$em</td><td>$dnam</td></tr>";
