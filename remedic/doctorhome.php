      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item"><a href="doctoranalysis1.php" class="nav-link">Analysis</a></li>
		   ...
		   <li class="nav-item"><a href="addtips.php" class="nav-link"></a></li>
    ...
    <section class="ftco-section bg-light">
      <div class="container">
        <div class="row justify-content-center mb-5 pb-3">
         <h1><font color="#FF0066" style="border:thick dashed"><b><i><u>Welcome to doctors Home page</u></i></b></font></h1>
        </div>
      </div>
    </section>
