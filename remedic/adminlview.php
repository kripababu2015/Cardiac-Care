...
$query = "select * from tbl_login where type='lab' and
...
else
{
 ...
 while ($row = mysql_fetch_row($result))
 {
  ...
  echo '<td><a href=approvelab1.php?id='.

$idval.'>Approve</a></td><td><a href=deletelab.php?id='.
...
?>
		...
		<a href="adminapp.php"><h3><font color=blue>Back to approval page</font></h3></a>
      </div>
    </section>
